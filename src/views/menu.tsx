  ...
  return (
    <ul className="px-3 pt-5 pb-4">
      <li className="p-2 text-base">
        <a className="flex cursor-pointer" onClick={goToHome}>
      ...
      <li className="p-2 text-base">
        <a className="flex cursor-pointer" onClick={goToCredentials}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          ...
          <span className="ml-3">Credentials</span>
        </a>
      </li>
    </ul>
  )
